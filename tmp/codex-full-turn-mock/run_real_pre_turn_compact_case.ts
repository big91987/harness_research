...
const outDir = "/private/tmp/codex-real-pre-turn-compact-case";
const dumpPath = path.join(outDir, "dumped-responses-requests.json");
const codexHome = "/private/tmp/codex-real-pre-turn-compact-home";
